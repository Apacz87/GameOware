    ...
    switch(Message) {
                	...
                	if(Gra.IsItOver()){
                		...
                		if( ret == IDOK ){
                            ...
                            if( ret == IDOK ){
                                GameRestart();
                                if(Player1Round){
	                                MessageBox(NULL, "Grê zaczyna Gracz pierwszy","Start!",MB_ICONEXCLAMATION);
                                }
                                else{
	                                MessageBox(NULL, "Grê zaczyna Gracz drugi","Start!",MB_ICONEXCLAMATION);
                                }
        ...
        case WM_COMMAND:{
            if( LOWORD( wParam ) == 100 ){
                ...
                if( ret == IDOK ){
                    //MessageBox( hwnd, "Wybra³eœ \'OK\' w oknie dialogowym!", "Test", MB_ICONINFORMATION );
                    if(Player1Round){
	                    MessageBox(NULL, "Grê zaczyna Gracz pierwszy","Start!",MB_ICONEXCLAMATION);
                    }
                    else{
